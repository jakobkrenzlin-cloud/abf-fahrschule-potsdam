          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            <div className="bg-blue-600 text-white p-6">
              ...
              <div className="bg-white/20 rounded-lg p-4">
                ...
                <div className="text-xs text-blue-100 mt-2">Preis gemäß § 32 Fahrlehrergesetz: Unterweisungsstunde ab 67,50 €/45 Min., Übungsstunde 67,50 €/45 Min. und Besondere Ausbildungsfahrten 75 €/45 Min.</div>
              </div>
            </div>
