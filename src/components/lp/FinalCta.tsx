    ...
    <div className="max-w-3xl mx-auto px-4 text-center">
      <Reveal>
        ...
        <button
          type="button"
          onClick={onClick}
          className="mt-8 inline-flex items-center justify-center gap-2 min-h-[56px] px-8 rounded-xl bg-brand hover:bg-brand-strong text-white text-lg font-bold transition-colors"
        >
          {buttonLabel}
