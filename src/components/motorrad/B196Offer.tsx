    ...
    <section className="py-10 sm:py-16 lg:py-20 bg-gradient-to-b from-black to-[#0a1628]">
      <div className="max-w-5xl mx-auto px-4">
        <div className="text-center mb-6 sm:mb-8">
          <span className="inline-block bg-brand-strong/20 text-brand text-xs sm:text-sm font-bold uppercase tracking-wider px-3 py-1.5 rounded-full border border-brand-strong/40 mb-3">
            Beliebteste Erweiterung
          </span>
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-3">
            B196 in Potsdam: <span className="text-brand">125ccm fahren mit deinem Autoführerschein</span>
          </h2>
        ...
        <div className="bg-neutral-900 rounded-2xl border border-brand-strong/30 shadow-xl p-5 sm:p-8 lg:p-10 max-w-3xl mx-auto">
          {/* Price */}
          <div className="text-center mb-6 sm:mb-8 pb-5 sm:pb-6 border-b border-neutral-700">
            ...
            <div className="text-5xl sm:text-6xl lg:text-7xl font-black text-brand">750 €</div>
          ...
          <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
            <li className="flex items-start gap-3">
              <CheckCircle className="w-5 sm:w-6 h-5 sm:h-6 text-brand flex-shrink-0 mt-0.5" />
