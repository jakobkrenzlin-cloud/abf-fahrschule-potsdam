      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {advantages.map((advantage, index) => {
            ...
            return (
              <div key={index} className="text-center p-6 rounded-2xl bg-neutral-50 hover:shadow-lg transition-shadow duration-300">
                <div className="bg-orange-100 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6">
                  <Icon className="w-10 h-10 text-orange-500" />
                </div>
                <h3 className="font-bold text-xl text-neutral-900 mb-3">{advantage.title}</h3>
