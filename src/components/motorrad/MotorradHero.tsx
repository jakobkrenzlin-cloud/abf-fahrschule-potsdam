    ...
    <section className="relative min-h-[70vh] sm:min-h-[80vh] flex items-center">
      ...
      <div className="absolute inset-0 z-0">
        <img
          ...
          height={900}
        />
        <div className="absolute inset-0 bg-gradient-to-r from-black/95 via-black/80 to-brand-dark/60" />
      </div>

      <div className="relative z-10 max-w-7xl mx-auto px-4 py-10 sm:py-16 lg:py-24">
        <div className="max-w-2xl">
          {/* Trust Badge */}
          <div className="inline-flex items-center gap-2 bg-brand-strong/20 border border-brand-strong/40 px-3 py-1.5 rounded-full text-xs sm:text-sm font-bold mb-4 text-white">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-6xl font-black text-white mb-3 sm:mb-4 leading-tight">
            ...
            <span className="block text-brand">125ccm mit dem Autoführerschein</span>
          </h1>
          ...
          <p className="text-lg sm:text-xl lg:text-2xl text-neutral-200 mb-6 sm:mb-8">
            ...
            <span className="text-brand font-bold">Komplettpreis 750 €</span>{' '}
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-4 mb-6 sm:mb-8">
            <div className="flex items-center gap-2 bg-brand-strong/20 backdrop-blur-sm rounded-full px-3 sm:px-4 py-2 border border-brand-strong/30">
              <CheckCircle className="w-4 sm:w-5 h-4 sm:h-5 text-brand flex-shrink-0" />
