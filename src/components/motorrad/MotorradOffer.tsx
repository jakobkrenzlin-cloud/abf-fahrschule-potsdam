      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white">
            Dein All-Inclusive Startpaket für nur <span className="text-brand">599€</span>
          </h2>
        </div>

        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
          {/* Left Column - Image */}
          <div className="relative rounded-xl sm:rounded-2xl overflow-hidden shadow-xl border border-brand-strong/20">
            <img 
              src={storefrontImage} 
          ...
          <div className="bg-neutral-900 rounded-xl sm:rounded-2xl shadow-xl border border-brand-strong/20 p-5 sm:p-8">
            ...
            <div className="text-center mb-6 sm:mb-8 pb-4 sm:pb-6 border-b border-neutral-700">
              <div className="flex items-baseline justify-center gap-2 sm:gap-3">
                <span className="text-5xl sm:text-6xl lg:text-7xl font-black text-brand">599€</span>
            ...
            <ul className="space-y-3 sm:space-y-4">
              <li className="flex items-center gap-2 sm:gap-3">
                <CheckCircle className="w-5 sm:w-6 h-5 sm:h-6 text-brand-strong flex-shrink-0" />
              ...
              <li className="flex items-center gap-2 sm:gap-3">
                ...
                <span className="text-brand text-xs sm:text-sm font-medium whitespace-nowrap">Wert: 50€</span>
              </li>
              <li className="flex items-center gap-2 sm:gap-3">
                <CheckCircle className="w-5 sm:w-6 h-5 sm:h-6 text-brand-strong flex-shrink-0" />
                <div className="flex-1 min-w-0">
                ...
                <span className="text-brand text-xs sm:text-sm font-medium whitespace-nowrap">Wert: 30€</span>
              </li>
              <li className="flex items-center gap-2 sm:gap-3">
                <Gift className="w-5 sm:w-6 h-5 sm:h-6 text-brand-strong flex-shrink-0" />
                <div className="flex-1 min-w-0">
                  <span className="text-white font-medium text-sm sm:text-base">100€ Louis und Polo Gutschein</span>
                </div>
                <span className="text-brand text-xs sm:text-sm font-medium whitespace-nowrap">Geschenkt!</span>
              </li>
              <li className="flex items-center gap-2 sm:gap-3">
                <Gift className="w-5 sm:w-6 h-5 sm:h-6 text-brand-strong flex-shrink-0" />
                <div className="flex-1 min-w-0">
                ...
                <span className="text-brand text-xs sm:text-sm font-medium whitespace-nowrap">Wert: 54€</span>
              </li>
            </ul>

            {/* Total Value - Blue background */}
            <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-neutral-700 bg-brand-strong/10 -mx-5 sm:-mx-8 -mb-5 sm:-mb-8 p-4 sm:p-6 rounded-b-xl sm:rounded-b-2xl">
              ...
              <div className="flex justify-between items-center mt-2">
                <span className="text-brand font-bold text-base sm:text-lg">Du sparst:</span>
                <span className="text-xl sm:text-2xl font-black text-brand">Über 280€!</span>
              </div>
            </div>
          </div>
        </div>
