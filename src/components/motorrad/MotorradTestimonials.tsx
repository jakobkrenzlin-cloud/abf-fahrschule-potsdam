...
const MotorradTestimonials: React.FC = () => {
  return (
    <section className="py-10 sm:py-16 lg:py-20 bg-gradient-to-b from-brand-dark to-black">
      <div className="max-w-6xl mx-auto px-4">
        ...
        {/* Google Reviews CTA */}
        <div className="bg-neutral-900 border border-brand-strong/30 rounded-2xl p-8 sm:p-10 text-center max-w-2xl mx-auto">
          <div className="bg-brand-strong/20 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-5">
