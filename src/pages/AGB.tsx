...
const AGB = () => {
  return <div className="min-h-screen bg-white">
      <Helmet>
        <title>AGB | ABF Fahrschule Potsdam</title>
        <meta name="description" content="Allgemeine Geschäftsbedingungen der ABF Fahrschule Potsdam für PKW- und Motorrad-Führerscheinausbildung." />
        <link rel="canonical" href="https://abf-fahrschule-potsdam.lovable.app/agb" />
      </Helmet>
      <Header />
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg max-w-none">
          <p className="mb-4 text-sm text-ink/75">Diese AGB gelten für Verträge, die über unsere Website oder in der Fahrschule geschlossen werden.</p>

          <h2 className="text-xl font-semibold text-brand-dark mb-4 mt-8">§ 1 Geltungsbereich</h2>
          ...
          <h2 className="text-xl font-semibold text-brand-dark mb-4 mt-8">§ 2 Vertragsabschluss</h2>
          ...
          <h2 className="text-xl font-semibold text-brand-dark mb-4 mt-8">§ 3 Leistungen und Preise der Fahrschule (gemäß § 32 FahrlG)</h2>
          <p className="mb-4"><strong>Grundbetrag (199 € Herbst-Angebot) beinhaltet:</strong></p>
          <ul className="mb-4 ml-6 list-disc">
          ...
          <h2 className="text-xl font-semibold text-brand-dark mb-4 mt-8">§ 4 Pflichten des Kunden</h2>
          ...
          <h2 className="text-xl font-semibold text-brand-dark mb-4 mt-8">§ 5 Preise und Zahlungsbedingungen</h2>
          ...
          <ul className="mb-4 ml-6 list-disc">
            <li>Der Grundbetrag (199 € Herbst-Angebot) ist bei Vertragsabschluss fällig</li>
          ...
          <h2 className="text-xl font-semibold text-brand-dark mb-4 mt-8">§ 6 Absage und Stornierung von Fahrstunden</h2>
          <ul className="mb-4 ml-6 list-disc">
          ...
          <h2 className="text-xl font-semibold text-brand-dark mb-4 mt-8">§ 7 Widerrufsrecht bei Online-Anmeldung</h2>
          <p className="mb-4"><strong>Widerrufsbelehrung für Verbraucher (§ 312g BGB):</strong></p>
          
          <div className="bg-surface p-6 rounded-lg mb-4">
            <h3 className="text-lg font-semibold text-brand-dark mb-3">Widerrufsrecht</h3>
            ...
            <h3 className="text-lg font-semibold text-brand-dark mb-3 mt-6">Folgen des Widerrufs</h3>
            ...
            <h3 className="text-lg font-semibold text-brand-dark mb-3 mt-6">Vorzeitiges Erlöschen des Widerrufsrechts</h3>
          ...
          <h2 className="text-xl font-semibold text-brand-dark mb-4 mt-8">§ 8 Haftung</h2>
          ...
          <h2 className="text-xl font-semibold text-brand-dark mb-4 mt-8">§ 9 Kündigung und Vertragsbeendigung</h2>
          ...
          <h2 className="text-xl font-semibold text-brand-dark mb-4 mt-8">§ 10 Datenschutz</h2>
          ...
          <p className="mb-4">Nähere Informationen finden Sie in unserer <Link to="/datenschutz" className="text-brand-strong hover:text-brand-strong">Datenschutzerklärung</Link>.</p>

          <h2 className="text-xl font-semibold text-brand-dark mb-4 mt-8">§ 11 Online-Streitbeilegung</h2>
          <p className="mb-4">Die Europäische Kommission stellt eine Plattform zur Online-Streitbeilegung (OS) bereit: <a href="https://ec.europa.eu/consumers/odr/" className="text-brand-strong hover:text-brand-strong" target="_blank" rel="noopener noreferrer">https://ec.europa.eu/consumers/odr/</a></p>
          ...
          <h2 className="text-xl font-semibold text-brand-dark mb-4 mt-8">§ 12 Schlussbestimmungen</h2>
