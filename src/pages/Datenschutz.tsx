...
const Datenschutz = () => {
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <title>Datenschutz | ABF Fahrschule Potsdam</title>
        <meta name="description" content="DSGVO-konforme Datenschutzerklärung der ABF Fahrschule Potsdam: Verarbeitung, Rechte und Cookies im Überblick." />
        <link rel="canonical" href="https://abf-fahrschule-potsdam.lovable.app/datenschutz" />
      </Helmet>
      <Header />
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg max-w-none">
          <h2 className="text-xl font-semibold text-brand-dark mb-4">1. Datenschutz auf einen Blick</h2>
          
          <h3 className="text-lg font-semibold text-brand-dark mb-2">Allgemeine Hinweise</h3>
          ...
          <h2 className="text-xl font-semibold text-brand-dark mb-4 mt-8">2. Verantwortliche Stelle</h2>
          ...
          <p className="mb-4">
            ...
            E-Mail: <a href="mailto:potsdam@fahrschuleabf.de" className="text-brand-strong hover:text-brand-strong">potsdam@fahrschuleabf.de</a>
          </p>
          ...
          <h2 className="text-xl font-semibold text-brand-dark mb-4 mt-8">3. Datenerfassung auf dieser Website</h2>
          
          <h3 className="text-lg font-semibold text-brand-dark mb-2 mt-6">3.1 Kontaktformular & Online-Anmeldung</h3>
          ...
          <h3 className="text-lg font-semibold text-brand-dark mb-2 mt-6">3.2 Server-Log-Dateien</h3>
          ...
          <h2 className="text-xl font-semibold text-brand-dark mb-4 mt-8">4. Hosting und externe Dienste</h2>
          
          <h3 className="text-lg font-semibold text-brand-dark mb-2 mt-6">4.1 Lovable / Supabase</h3>
          ...
          <h3 className="text-lg font-semibold text-brand-dark mb-2 mt-6">4.2 Google Fonts (lokal eingebunden)</h3>
          ...
          <h2 className="text-xl font-semibold text-brand-dark mb-4 mt-8">5. Cookie-Banner & Einwilligung</h2>
          
          <h3 className="text-lg font-semibold text-brand-dark mb-2 mt-6">5.1 Cookie-Consent-Banner</h3>
          ...
          <h2 className="text-xl font-semibold text-brand-dark mb-4 mt-8">6. Analyse- und Marketing-Tools</h2>
          
          <h3 className="text-lg font-semibold text-brand-dark mb-2 mt-6">6.1 Google Ads Conversion-Tracking</h3>
          ...
          <p className="mb-4">Weitere Informationen: <a href="https://policies.google.com/privacy" className="text-brand-strong hover:text-brand-strong" target="_blank" rel="noopener noreferrer">Google Datenschutzerklärung</a></p>

          <h3 className="text-lg font-semibold text-brand-dark mb-2 mt-6">6.2 Google Analytics (optional)</h3>
          ...
          <h2 className="text-xl font-semibold text-brand-dark mb-4 mt-8">7. Externe Kommunikationskanäle</h2>
          
          <h3 className="text-lg font-semibold text-brand-dark mb-2 mt-6">7.1 WhatsApp-Kontakt</h3>
          ...
          <p className="mb-4">Wir haben keinen Einfluss auf die durch WhatsApp verarbeiteten Daten. Weitere Informationen: <a href="https://www.whatsapp.com/legal/privacy-policy" className="text-brand-strong hover:text-brand-strong" target="_blank" rel="noopener noreferrer">WhatsApp Datenschutz</a></p>

          <h2 className="text-xl font-semibold text-brand-dark mb-4 mt-8">8. Ihre Rechte als betroffene Person</h2>
          ...
          <h3 className="text-lg font-semibold text-brand-dark mb-2 mt-6">Zuständige Aufsichtsbehörde</h3>
          <p className="mb-4">
            ...
            E-Mail: <a href="mailto:poststelle@lda.brandenburg.de" className="text-brand-strong hover:text-brand-strong">poststelle@lda.brandenburg.de</a>
          </p>

          <h2 className="text-xl font-semibold text-brand-dark mb-4 mt-8">9. Speicherdauer</h2>
          ...
          <h2 className="text-xl font-semibold text-brand-dark mb-4 mt-8">10. Datensicherheit</h2>
          ...
          <h2 className="text-xl font-semibold text-brand-dark mb-4 mt-8">11. Kontakt in Datenschutzfragen</h2>
