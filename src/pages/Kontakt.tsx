        ...
        <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="bg-gradient-to-r from-primary/10 to-primary/5 rounded-2xl p-8 mb-12">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-3xl mx-auto">
              ...
              <a href="mailto:potsdam@fahrschuleabf.de" className="block">
                <Button size="lg" variant="outline" className="w-full text-base">
            ...
            <p className="text-center text-muted-foreground mt-4">
              ...
              ✉️ <a href="mailto:potsdam@fahrschuleabf.de" className="text-primary hover:underline">potsdam@fahrschuleabf.de</a>
            </p>
          </div>
