    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
              ...
              <div className="lg:pr-8">
                ...
                <div className="mb-4">
                  <span className="inline-block text-primary text-5xl lg:text-7xl font-black">
                    179 €
                  </span>
                </div>
                ...
                <div className="lg:hidden">
                  <Button 
                    ...
                    className="w-full bg-primary hover:bg-cta-hover text-primary-foreground text-lg py-6 rounded-xl font-bold shadow-lg"
                  >
                ...
                <form onSubmit={handleFormSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input 
                      ...
                      className="mt-1.5 h-14 border border-input bg-card focus:border-primary focus:ring-primary rounded-xl text-lg p-4" 
                  ...
                  {showPrivacyConsent && (
                    <div className="bg-secondary rounded-xl p-4 space-y-3 animate-in fade-in slide-in-from-top-2">
                  ...
                  <Button 
                    ...
                    className="w-full bg-primary hover:bg-cta-hover text-primary-foreground h-16 text-xl font-bold rounded-xl shadow-lg transition-all duration-300 hover:scale-[1.02] disabled:opacity-50"
                  >
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-3">
              Das bekommst du für <span className="text-primary">179 €</span>
            </h2>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="text-center mt-8">
            <a 
              ...
              className="inline-flex items-center gap-2 text-primary hover:text-cta-hover hover:underline font-medium"
            >
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="text-center mt-10">
            <Button 
              size="lg" 
              onClick={scrollToForm}
              className="bg-primary hover:bg-cta-hover text-primary-foreground text-lg px-10 py-6 rounded-xl font-bold shadow-lg"
            >
      ...
      <section className="py-16 bg-primary">
        <div className="max-w-3xl mx-auto px-4 text-center text-primary-foreground">
          ...
          <Button 
            size="lg" 
            onClick={scrollToForm}
            className="bg-card hover:bg-card/90 text-primary text-xl px-12 py-7 rounded-xl font-bold shadow-lg"
          >
            Ja, 179 € Angebot sichern!
          </Button>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-card border-t border-border shadow-xl z-50 md:hidden safe-area-inset-bottom">
        <div className="p-3">
          <Button 
            onClick={scrollToForm}
            className="w-full bg-primary hover:bg-cta-hover text-primary-foreground py-4 rounded-xl font-bold text-lg shadow-lg"
          >
            Ja, 179 € Angebot sichern!
          </Button>
        </div>
